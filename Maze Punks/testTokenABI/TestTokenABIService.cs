...
using Nethereum.Unity.WebglMain.Contracts.testTokenABI.ContractDefinition;

namespace Nethereum.Unity.WebglMain.Contracts.testTokenABI
{
    public partial class TestTokenABIService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, TestTokenABIDeployment testTokenABIDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<TestTokenABIDeployment>().SendRequestAndWaitForReceiptAsync(testTokenABIDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, TestTokenABIDeployment testTokenABIDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TestTokenABIDeployment>().SendRequestAsync(testTokenABIDeployment);
        }

        public static async Task<TestTokenABIService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, TestTokenABIDeployment testTokenABIDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, testTokenABIDeployment, cancellationTokenSource);
            return new TestTokenABIService(web3, receipt.ContractAddress);
        }
        ...
        public TestTokenABIService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
