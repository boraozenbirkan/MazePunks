...
namespace Nethereum.Unity.WebglMain.Contracts.testTokenABI.ContractDefinition
{


    public partial class TestTokenABIDeployment : TestTokenABIDeploymentBase
    {
        public TestTokenABIDeployment() : base(BYTECODE) { }
        public TestTokenABIDeployment(string byteCode) : base(byteCode) { }
    }

    public class TestTokenABIDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "0x";
        public TestTokenABIDeploymentBase() : base(BYTECODE) { }
        public TestTokenABIDeploymentBase(string byteCode) : base(byteCode) { }
