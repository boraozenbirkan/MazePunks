...
namespace Contracts.Contracts.Items.ContractDefinition
{


    public partial class ItemsDeployment : ItemsDeploymentBase
    {
        public ItemsDeployment() : base(BYTECODE) { }
        public ItemsDeployment(string byteCode) : base(byteCode) { }
    }

    public class ItemsDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "0x";
        public ItemsDeploymentBase() : base(BYTECODE) { }
        public ItemsDeploymentBase(string byteCode) : base(byteCode) { }
    ...
    public partial class ExecuteItemActivationProposalFunction : ExecuteItemActivationProposalFunctionBase { }

    [Function("executeItemActivationProposal")]
    public class ExecuteItemActivationProposalFunctionBase : FunctionMessage
    {
        [Parameter("uint256", "_proposalID", 1)]
        public virtual BigInteger ProposalID { get; set; }
    }
    ...
    public partial class ProposeItemActivationUpdateFunction : ProposeItemActivationUpdateFunctionBase { }

    [Function("proposeItemActivationUpdate")]
    public class ProposeItemActivationUpdateFunctionBase : FunctionMessage
    {
    ...
    {
        [Parameter("string", "itemName", 1)]
        public virtual string ItemName { get; set; }
        [Parameter("bool", "isActive", 2)]
        public virtual bool IsActive { get; set; }
        [Parameter("string", "uri", 3)]
        public virtual string Uri { get; set; }
        [Parameter("uint256", "mintCost", 4)]
        public virtual BigInteger MintCost { get; set; }
        [Parameter("uint256", "totalSupply", 5)]
