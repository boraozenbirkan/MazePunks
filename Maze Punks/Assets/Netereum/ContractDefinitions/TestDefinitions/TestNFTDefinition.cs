...
namespace ContractDefinitions.Contracts.testNFT.ContractDefinition
{


    public partial class TestNFTDeployment : TestNFTDeploymentBase
    {
        public TestNFTDeployment() : base(BYTECODE) { }
        public TestNFTDeployment(string byteCode) : base(byteCode) { }
    }

    public class TestNFTDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "0x";
        public TestNFTDeploymentBase() : base(BYTECODE) { }
        public TestNFTDeploymentBase(string byteCode) : base(byteCode) { }
    ...
    public partial class UpdateTokenAddressFunction : UpdateTokenAddressFunctionBase { }

    [Function("updateTokenAddress")]
    public class UpdateTokenAddressFunctionBase : FunctionMessage
    {
